...
public class ControllerEditProfile {
	...
	@FXML
	private Pane paneEditProfile, paneEditProfileHead;
	@FXML
	private TextField txtFirstName, txtLastName;
	@FXML
	private PasswordField txtNewPassword, txtRepeatPassword;
	@FXML
	...
	private void initPopup() {
		...
		Label label = new Label(
				"Do you really want to change your Admin rights? You will be logged out and cant go back to be an admin.");
	...
	private void onChangePasswordClicked(MouseEvent me) {
		if (txtNewPassword.getText() != txtRepeatPassword.getText() || txtNewPassword.getText().equals("")
