...
/**
 * Name: Converter
 * Used in converter-module.js
 */
var logger_Converter = log4js.getLogger('Converter');

/* Settings */
var runDevSettings = function () {
    logger_Application.level = 'info';
    logger_Response_Handler.level = 'debug';
...
module.exports.lineFeed = lineFeed;
