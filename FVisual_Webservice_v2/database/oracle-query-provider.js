...
module.exports.MTG_GET_EINSAETZE = "SELECT id, id_einsatzcode, id_einsatzart, titel, kurzbeschreibung, adresse, plz FROM Einsaetze INNER JOIN MTG_WB_EINSATZ ON id_einsatz = id WHERE id_mitglied = :1";
...
module.exports.EINSATZ_GET = "SELECT E.id, E.id_einsatzart, EA.beschreibung, MTG_WB_EINSATZ.ID_STUETZPUNKT, E.id_einsatzcode, EC.code, E.titel, E.kurzbeschreibung, E.adresse, E.plz FROM Einsaetze E INNER JOIN Einsatzcodes EC ON E.id_einsatzcode = EC.id INNER JOIN Einsatzarten EA on E.id_einsatzart = EA.id INNER JOIN MTG_WB_EINSATZ ON MTG_WB_EINSATZ.ID_EINSATZ = E.ID";
module.exports.EINSATZ_GET_BY_ID = "SELECT E.id, E.id_einsatzart, EA.beschreibung, E.id_einsatzcode, EC.code, E.titel, E.kurzbeschreibung, E.adresse FROM Einsaetze E INNER JOIN Einsatzcodes EC ON E.id_einsatzcode = EC.id INNER JOIN Einsatzarten EA on E.id_einsatzart = EA.id WHERE E.id = :1";
module.exports.EINSATZ_GET_BY_TITEL = "SELECT E.id, E.id_einsatzart, EA.beschreibung, E.id_einsatzcode, EC.code, E.titel, E.kurzbeschreibung, E.adresse, plz FROM Einsaetze E INNER JOIN Einsatzcodes EC ON E.id_einsatzcode = EC.id INNER JOIN Einsatzarten EA on E.id_einsatzart = EA.id WHERE E.titel = :1";
...
module.exports.EINSATZ_POST = "INSERT INTO Einsaetze(id, id_einsatzcode, id_einsatzart, titel, kurzbeschreibung, adresse, plz) VALUES(seq_Einsaetze.nextval, :1, :2, :3, :4, :5, :6)";
/* IS support */
