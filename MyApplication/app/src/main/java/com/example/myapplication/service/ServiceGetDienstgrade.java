...
public class ServiceGetDienstgrade extends AsyncTask<String, Void, String> {
    private static final String URL = "/dienstgrade";
    ...
    protected String doInBackground(String... command) {
        ...
        try {
            ...
            conn.addRequestProperty("metadata", "[{\"id\":\"ID\", \"kuerzel\":\"KUERZEL\", \"bezeichnung\":\"BEZEICHNUNG\"}]");
