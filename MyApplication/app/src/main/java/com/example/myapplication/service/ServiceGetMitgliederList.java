...
public class ServiceGetMitgliederList extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... command) {
        ...
        try {
            ...
            conn.addRequestProperty("metadata", "[{\"id\":\"ID\", \"id_dienstgrad\":\"ID_DIENSTGRAD\" , \"id_stuetzpunkt\": \"ID_STUETZPUNKT\", \"vorname\":\"VORNAME\", \"nachname\":\"NACHNAME\", \"username\": \"USERNAME\", \"password\": \"PASSWORD\", \"isAdmin\": \"ISADMIN\"}]");
